...
public class DisplayAlphabetsMdpi extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.display_alphabets_mdpi);
		...
		gotoCanvas.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent canVas = new Intent(DisplayAlphabetsMdpi.this, Canavs_mdpi.class);
				canVas.putExtra("val", curValue);
