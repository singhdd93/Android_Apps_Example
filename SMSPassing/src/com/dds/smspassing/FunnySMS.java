...
public class FunnySMS extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		smsList=getResources().getStringArray(R.array.sms_list1);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		// TODO Auto-generated method stub
		String smsListType = "smsList1";
		
		Intent i = new Intent(FunnySMS.this, SendSMS.class);
