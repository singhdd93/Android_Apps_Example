...
public final class FlirtSMS extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		smsList=getResources().getStringArray(R.array.sms_list3);
	...
	String smsListType = "smsList3";
	
	Intent i = new Intent(FlirtSMS.this, SendSMS.class);
